...
from hymed_no_kafka.config import DIFY_SERVER, DIFY_USER, DIFY_CHATFLOW_KEY
                ...
                while "\n\n" in buffer:
                    ...
                    try:
                        ...
                        if isinstance(payload, dict):
                            ...
                            event_callback({"event": event_type or "agent_message", "answer": str(payload)})
                    except json.JSONDecodeError:
                        event_callback({"event": event_type or "agent_message", "answer": data_str})
        finally:
